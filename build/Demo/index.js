	          ...
	          "children": [
	            {
	              "type": "text",
	              "attr": {
	                "value": "账号：admin 密码：admin。数据库与小程序打通，需要注册、上传文件等功能，请看小程序代码，js写法是一模一样的。"
	              }
	            }
	          ]
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var notification = $app_require$('@app-module/system.notification');
	
	
	_BmobHap111Min2.default.initialize('39ee83f92ff3a195130596a4eaec5ddf', 'a1223fca87f5d229953817f5c2493446');
	exports.default = {
	  data: {
	    title: 'Bmob后端云',
	    u: '',
	  ...
	  getU: function getU(e) {
	    this.u = e.text;
	  },
	  getP: function getP(e) {
	    this.p = e.text;
	  },
	  routeDetail: function routeDetail(e) {
	    console.log('ks', this.u, this.p);
	    _BmobHap111Min2.default.User.login(this.u, this.p).then(function (res) {
